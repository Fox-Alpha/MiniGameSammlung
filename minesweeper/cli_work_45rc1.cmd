...
set "gdpath=C:\Coding\DevProgramme\GodotEngine\Godot_v4.5-rc"
set "godotexe=Godot_v4.5-rc1_win64_console.exe"
set "godotver=Godot_v4.5-rc1_win64.exe --version"
...
set "build_version=_alpha1"
REM Version sufffix for Engine Version
set "build_gdversion="
FOR /F %%I IN ('=%gdpath%\%godotver%') DO @SET "build_gdversion=%%I"

set "build_project_name=Minesweeper_Retro"
REM Path to Export root folder
set "build_path=P:\3. GODOT Projekte\Projekte\MiniGameSammlung\.Export\%build_gdversion%\%build_project_name%"
